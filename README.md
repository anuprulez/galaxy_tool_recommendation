...
2. Execute `sh train.sh` (https://github.com/anuprulez/galaxy_tool_recommendation/blob/cnn_wc/train.sh). It runs on a subset of workflows. Use file `data/worflow-connection-20-04.tsv` in the training script to train on complete set of workflows (It takes a long time to finish).
